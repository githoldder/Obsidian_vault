...
回顾 [[经验-RankBrain]]：它能理解查询之间的语义关系——知道 "tbsp to cup" 和 "how many tablespoons in a cup" 是同一类问题。但 RankBrain 有一个根本性的盲区：它只理解查询，不理解文档。它在"用户想搜什么"这一端做了语义化，但到了"网页写了什么"这一端，还是回到 TF-IDF 式关键词匹配 🔍。
