...
| GB/T 3100—2022 | 国际单位制及其应用 | 2022-12-30 | 2023-07-01 | **现行** | 理工科论文/lab-report-template/技术文档量和单位规范 |
...
|---|---|---|---|
| **学术文档** | 课程论文、lab-report-template、文献综述、开题报告、毕业论文、调研报告 | GB/T 7713.1/2、GB/T 7714 | 毕业论文模板、course-paper-template |
...
| **会议协作文档** | 会议纪要、决策记录、头脑风暴记录、评审记录 | 无强制标准 | meeting-minutes-template |
...
### 11.3 project-retrospective-template
...
- [[51-PARA-Management]] — 项目文件组织规范
- [[35-BibTeX-Lifecycle]] — 学术文档编写规范（LaTeX 输出）
