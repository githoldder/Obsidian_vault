Eclipse 是一个功能强大的 Java IDE，适合 Java 开发者使用。以下是 Eclipse 编译运行 Java 代码的详细教程：
...
1. **下载 Eclipse**
    ...
    - 访问 [Eclipse 官网](https://www.eclipse.org/downloads/) 下载 **Eclipse IDE for Java Developers** 版本。
    - 选择适合你系统的版本（Windows、macOS 或 Linux）。
2. **安装 Eclipse**
    
    - 下载后运行安装程序，选择 **Eclipse IDE for Java Developers** 进行安装。
    - 安装完成后，启动 Eclipse。

---

### **二、创建 Java 项目并运行 Java 代码**
